<template>
  <div class="header" v-show="isshow">
    ...
    >
      ...
      <el-submenu index="2" >
        <template slot="title" class="test">书评</template>
        <el-menu-item index="2-1" @click="setclass">
          <!-- 话题 -->
          <router-link class="router-link stylecolor" style="color:inherit;"  to="/topic" 
            >话题</router-link
          >
        ...
        <el-submenu index="2-3">
          ...
          <el-menu-item index="2-3-1" v-on:click="onchang('night')"
            >黑夜</el-menu-item
          >
          <el-menu-item index="2-3-2">undefind</el-menu-item>
          <el-menu-item index="2-3-3">undefind</el-menu-item>
        </el-submenu>
...
export default {
  ...
  methods: {
    ...
    setclass(){
        this.isactive=" el-menu-item is-active"
    },
    //  out_l(){
    //       setTimeout(()=>{
    //            this.isshow=true
